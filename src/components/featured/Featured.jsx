...
const Featured = () => {
  ...
  const { data, loading, error } = useFetch("https://bookkaro.onrender.com/hotels/countByCity?cities=berlin,madrid,london");
      ...
      {loading ? ("Loading..."
        ...
        <>
          <div className="featuredItem" onClick={() => {
            navigate("/hotels", {
              state: {
                destination: "berlin", dates: [
                  {
                    "startDate": "2024-10-31T18:30:00.000Z",
                    "endDate": "2024-11-01T18:30:00.000Z",
                    "key": "selection"
                  }
